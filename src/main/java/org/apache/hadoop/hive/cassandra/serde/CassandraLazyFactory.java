...
import org.apache.hadoop.hive.serde2.lazy.CassandraLazyString;
...
public class CassandraLazyFactory {
     ...
     * struct uses 1 level of separator, and map uses 2 levels: the first one
     * for delimiting entries, the second one for delimiting key and values.
     ...
     *
     * @param lastColumnTakesRest whether the last column of the struct should
     * take the rest of the row if there are extra fields.
